...
$query = "SELECT Fullname, Email, Password, Phone_number, Dob, Country, Gender FROM receptionist";
...
<head>
    ...
    <style>
        body {
            background-color: rgb(147, 218, 127);
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<p><span class="label">Password:</span> ' . htmlspecialchars($row['Password']) . '</p>';
                echo '<p><span class="label">Phone_number:</span> ' . htmlspecialchars($row['Email']) . '</p>';
